        ...
        <div class="w-full h-full bg-primary-lightest overflow-y-scroll">
          ...
          <div class="relative container py-5 border-b">
            <div class="flex justify-between items-center">
              <h3>
                Cart <span v-if="cart">(){{ cart.itemQuantity }})</span>
              </h3>
          ...
          <div v-else class="container py-10">Your cart is empty.</div>

          <!-- Footer -->
          <div class="bg-primary-lighter border-t">
            ...
            <!-- Summary -->
            <div v-if="cart" class="container py-6 border-b">
...
export default {
  ...
  async fetch() {
    const { $swell } = this
    this.cartInfoText = await $swell.settings.get('cartInfoText')
  },
  ...
  mounted() {
    const { checkout_id: checkoutId } = this.$route.query
